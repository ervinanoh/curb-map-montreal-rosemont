...
import findRoute, {
  getUrlQuery,
} from '/home/eanoh/Bureau/CurbLr/curb-map-montreal-rosemont/node_modules/umi-build-dev/lib/findRoute.js';
...
(() => {
  try {
    ...
    require('../../../node_modules/umi-plugin-ui/lib/bubble').default({
      port: 3000,
      path: '/home/eanoh/Bureau/CurbLr/curb-map-montreal-rosemont',
      currentProject: '',
      isBigfish: undefined,
    });
  } catch (e) {
